### Analyse the current situation regarding quantum computers
...
The data provided by this survey shows that the general public seem to be surprisingly aware of quantum computers to a certain degree. In addition, I would like to reference the recent growth in AI and compare it to statistics provided by this survey. For instance, services such as chat-GPT and Deepseek are well known among the population, however most people do not know any more than what they provide, with no or little knowledge of how they provide the answers or what consequences these tools may have. I fear that a similar situation may arise with the advent of quantum computing, where people will use the services provided by them and not know how these machines work on a deeper level.
### Source analysis
The study as a whole has been a strikingly useful tool for gaining statistics beyond my own capabilities, allowing me to form an estimate on how much people really know on this topic. Though I do have a few gripes with the survey, one being the sample size as a population of 1000 people, though useful, may not be sufficient to form generalisations. Though on further reading on the official paper, it states that the survey had been weighted to account for a wide range of age, background, and socioeconomic position. Furthermore, the questions have no way of knowing how much people know about quantum computers on more than a surface level.
